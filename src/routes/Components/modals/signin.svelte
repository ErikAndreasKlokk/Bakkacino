        ...
        <form on:submit={() => postSignIn()} class="modal-form {cForm} flex flex-col justify-between rounded-lg">
          ...
          <input tabindex="-1" type="submit" class=" w-0 m-0 p-0 h-0 !mt-0">
            <div class=" flex justify-between">
                ...
                <input class=" focus:!outline[0.3px] focus:!outline-surface-700 btn variant-filled !bg-primary-600 !text-surface-100 !rounded-lg cursor-pointer" type="submit" value="Sign In">
            </div>
        </form>
      </div>
    {/if}